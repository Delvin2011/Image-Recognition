...
class App extends React.Component {
  ...
  predictedConcept = (response) => {
    console.log(this.state.ModelOption.label);
      ...
      console.log(this.state.ModelOption.label);
      if((this.state.ModelOption.label === "NSFW" || this.state.ModelOption.label === "Fashion" || this.state.ModelOption.label === "General" || this.state.ModelOption.label === "Food" || this.state.ModelOption.label === "Moderation" || this.state.ModelOption.label === "Travel") && typeof(response) != 'undefined'){
        let clarifaiConcept = [];
        const products = [];
        let a = 0;
